    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->pushButton_8, SIGNAL(clicked()), this, SLOT(saveS1()));
    connect(ui->pushButton_9, SIGNAL(clicked()), this, SLOT(openS1()));
    connect(ui->pushButton_10, SIGNAL(clicked()), this, SLOT(saveS2()));
    connect(ui->pushButton_11, SIGNAL(clicked()), this, SLOT(openS2()));
